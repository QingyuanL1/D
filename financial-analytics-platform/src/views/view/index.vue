    ...
    <div class="max-w-7xl mx-auto">
      ...
      <div class="mb-8">
        ...
        <div v-if="currentCompany"
          class="mt-3 inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-blue-100 text-blue-800">
      ...
      <div class="bg-white p-6 rounded-lg shadow-sm mb-8">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div>
            ...
            <select v-model="selectedModule" @change="onModuleChange" :disabled="!selectedCategory"
              ...
              <option v-for="module in filteredModules" :key="module.id" :value="module">
                {{ module.module_name }}
              </option>
            </select>
          </div>
          ...
          <div>
            ...
            <input v-model="selectedPeriod" type="month" @change="onPeriodChange"
              class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500" />
          </div>
        </div>
        ...
        <div class="mt-6 flex space-x-4">
          <button @click="navigateToModule" :disabled="!selectedModule"
            class="px-6 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors">
            查看表单
          </button>
          <button @click="loadSubmissionDetails" :disabled="!selectedModule || !selectedPeriod"
...
const navigateToModuleDirectly = (module: Module) => {
  ...
  const routeMapping: { [key: string]: string } = {
    ...
    'tuoyuan_cost_center_structure': '/tuoyuan/cost-center-structure',
