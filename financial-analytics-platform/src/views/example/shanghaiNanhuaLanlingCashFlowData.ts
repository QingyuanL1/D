    ...
    const cashFlowData = ref<ShanghaiNanhuaLanlingCashFlowSection[]>([
        ...
        },
        {
            ...
            items: [
                ...
                },
                {
                    ...
                    field: 'asset_acquisition_payment',
                    currentAmount: null,
                    yearAmount: null,
                    lineNumber: '18'
                },
                ...
                {
                    name: '支付其他与投资活动有关的现金',
                    field: 'other_investment_payment_cash',
                    currentAmount: null,
                    yearAmount: null,
                    lineNumber: '20'
                },
        ...
        },
        {
            ...
            items: [
                {
                    name: '吸收投资收到的现金',
                    field: 'equity_investment_received',
                    currentAmount: null,
                    yearAmount: null,
                    lineNumber: '24'
                },
                ...
                },
                {
                    ...
                    field: 'dividend_interest_payment_cash',
                    currentAmount: null,
                    yearAmount: null,
                    lineNumber: '29'
                },
                {
                    name: '支付其他与筹资活动有关的现金',
                    field: 'other_financing_payment_cash',
                    currentAmount: null,
                    yearAmount: null,
                    lineNumber: '30'
                },
            ...
            items: [
                {
                    ...
                    field: 'exchange_rate_effect_on_cash',
                    currentAmount: null,
                    yearAmount: null,
                    isBold: true,
                    lineNumber: '33'
    ...
    const supplementaryData = ref<ShanghaiNanhuaLanlingCashFlowSection[]>([
        ...
        },
        {
            ...
            items: [
                ...
                {
                    name: '现金及现金等价物净增加净额',
                    field: 'final_cash_and_equivalents_net_increase_total',
                    currentAmount: null,
                    yearAmount: null,
                    isBold: true,
                    lineNumber: '68'
