<template>
  <div class="p-6 bg-gray-50 min-h-screen">
    <div class="max-w-7xl mx-auto">
      <!-- 页面标题 -->
      <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900">南华成本中心结构分析</h1>
      ...
      <div class="bg-white rounded-lg shadow-sm p-6 mb-8">
        <div class="flex justify-between items-center mb-6">
          ...
          <div class="flex items-center space-x-4">
            ...
            <div v-if="selectedYear !== '2025'" class="flex items-center">
...
const categories = {
  engineering: { name: '工程', color: '#3B82F6' },
  nonMainBusiness: { name: '非主营业务', color: '#10B981' }
}
...
const updateTrendChart = () => {
  ...
  const option = {
    title: {
      text: `${selectedYear.value}年南华成本中心月度趋势分析`,
      textStyle: {
        fontSize: 18,
        fontWeight: 'bold',
        color: '#374151'
...
const updateBarChart = () => {
  ...
  const option = {
    title: {
      text: `${selectedYear.value}年南华各板块当月计入损益对比`,
      textStyle: {
        fontSize: 18,
        fontWeight: 'bold',
        color: '#374151'
