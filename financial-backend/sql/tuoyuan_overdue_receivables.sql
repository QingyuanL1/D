-- 创建拓源公司逾期应收账款情况表
CREATE TABLE IF NOT EXISTS tuoyuan_overdue_receivables (
    ...
    collection_progress DECIMAL(10,2) DEFAULT 0 COMMENT '收款进度（%）',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='拓源公司逾期应收账款情况';

-- 初始化基础数据
INSERT INTO tuoyuan_overdue_receivables (period, segment_attribute, customer_attribute, year_beginning_balance, year_new_increase, current_collected, cumulative_collected, collection_progress) VALUES
